...
#include "style/qwindowsstyle_p.h"
    ...
    case PE_IndicatorArrowLeft:
        {
            ...
            QPixmap pixmap;
            QString pixmapName = uniqueName(QLatin1String("$qt_ia-")
                                      ...
                                      const QSize &csz, const QWidget *widget) const
{
    ...
    case CT_PushButton:
        if (const QStyleOptionButton *btn = qstyleoption_cast<const QStyleOptionButton *>(opt)) {
            ...
            int minwidth = int(QStyleHelper::dpiScaled(75., opt));
            int minheight = int(QStyleHelper::dpiScaled(23., opt));
