...
#ifdef _MSC_VER
    #if _MSC_VER >= 1900
        // Костыль для MSVS 2017 (поддержка стандарта C++11)
        // В принципе, всё логично: если нет памяти, то выполнять операции, могущие требовать
        // выделение памяти как-то не хорошо.
        // Можно написать свою обёртку (https://stackoverflow.com/questions/11133438/why-the-bad-allocconst-char-was-made-private-in-visual-c-2012),
        // но мне лень :-)
